...
void GameHandler::registerCoreOpcodes() {
    ...
    // WotLK phase-mask packet is known (uint32), but phase-aware terrain and
    // visibility are not implemented here. Server object creates/destroys still
    // apply normally; consuming this packet is not full phasing support.
...
void GameHandler::registerRemainingOpcodes() {
    ...
    // MSG_MOVE_SET_COLLISION_HGT is registered by MovementHandler below.
