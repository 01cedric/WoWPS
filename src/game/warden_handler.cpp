...
#else
    if (const char* h = std::getenv("HOME")) cacheBase = std::string(h) + "/.local/share/wowps/warden_cache";
    else cacheBase = "./warden_cache";
#endif
...
#else
                    std::string cacheDir;
                    if (const char* h = std::getenv("HOME")) cacheDir = std::string(h) + "/.local/share/wowps/warden_cache";
                    else cacheDir = "./warden_cache";
#endif
