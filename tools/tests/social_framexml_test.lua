...
assert(GetNumGossipOptions()==0)
local before=#commands
assert(not SelectGossipOption(1) and #commands==before)
__WoWPSLocal.innkeeper=false
print('PASS production innkeeper gossip: no invisible mail service or mail_open dispatch')
