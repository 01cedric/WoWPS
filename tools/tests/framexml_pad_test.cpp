...
int main() {
    ...
    require(localTargetOwnsShoulders(1,false,false,true),"noncombat target keeps interaction");
    require(localTargetOwnsShoulders(0,false,true),"Triangle clears bar immediately");
    require(localTargetOwnsShoulders(1,false,false,true),"friendly target retains talk after Back releases bar focus");
