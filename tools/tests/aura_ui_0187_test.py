...
ui.sync(p,c);assert(ui.events==2);p.statAuras[0].remainingMs=5000;ui.sync(p,c);assert(ui.events==4);p.statAuras.clear();ui.sync(p,c);assert(ui.events==6&&ui.sp.a.empty()&&ui.sp.mirror.empty());
