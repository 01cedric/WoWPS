...
"${CXX:-c++}" -std=c++20 -O1 -g -ffunction-sections -fdata-sections \
    ...
    "$ROOT/tools/tests/local_npc_spell_runtime_test.cpp" "$ROOT/src/game/local_gameplay.cpp" "$ROOT/src/game/local_melee.cpp" \
    ...
    -Wl,--gc-sections -pthread -o "$TEST_DIR/local_npc_spell_runtime_test"
"$TEST_DIR/local_npc_spell_runtime_test" 
