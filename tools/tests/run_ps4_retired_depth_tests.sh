...
PY_STUBS
"${CC:-cc}" -std=c11 -O1 -g ${SANITIZE:+-fsanitize=address,undefined -fno-omit-frame-pointer} -ffunction-sections -fdata-sections \
  -I "$backend/include" "$project_root/tools/tests/ps4_retired_depth_test.c" \
