#!/usr/bin/env python3
"""Execute production GLSL: conservative stratum coverage and depth-safe denoise.
...
out=root/'build-test-results/strata';out.mkdir(parents=True,exist_ok=True)
