...
int main(int argc,char** argv) {
    ...
    std::cout<<"PASS travel LAN/save: continent movement refusal; host/guest bind and hearth rollback/retry/replication; command replay; save12 inn/location/cooldown reload; real 128-NPC paged UDP roundtrip within 1400 bytes\n";
}
