...
"${CXX:-c++}" -std=c++20 -O1 -g -ffunction-sections -fdata-sections \
    ...
    "$ROOT/tools/tests/local_reviewed_original_content_test.cpp" \
    ...
    -Wl,--gc-sections -pthread -o "$TEST_DIR/local_reviewed_original_content_test"
"$TEST_DIR/local_reviewed_original_content_test" "$ROOT/assets/local_realm"
