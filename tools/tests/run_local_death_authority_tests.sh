...
"${CXX:-c++}" -std=c++20 -O1 -ffunction-sections -fdata-sections "${SAN_FLAGS[@]}" \
 -I"$ROOT/include" -I"$ROOT/extern" -I"$ROOT/extern/glm" \
 "$ROOT/tools/tests/local_death_authority_test.cpp" \
 ...
 -Wl,--gc-sections -pthread -o "$TEST_DIR/local_death_test"
"$TEST_DIR/local_death_test" "$ROOT/assets/local_realm/catalog"
