...
#include <SDL2/SDL.h>
#else
// No SDL on the console: the window is the piglet EGL context created by
// platform::ps4::initVideo. getSDLWindow() keeps its type and returns nullptr.
struct SDL_Window;
#endif
