...
public:
    ...
    // Standalone realm death must hold its last pose until authority revives it.
    ...
    void stopSpellCast();
    /// Interrupted casts return to locomotion without a release animation.
...
private:
    ...
    bool meleeSwingFresh_ = false;
    bool meleeSwingRestart_ = false;
