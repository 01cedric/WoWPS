#pragma once
#include "ui/character_name_keyboard.hpp"
...
public:
    ...
    /// GPU allocations/uploads must precede Renderer::beginFrame.
...
private:
    ...
    TextEdit name_{12};
    CharacterNameKeyboard nameKeyboard_;
    bool nameWasFocused_ = false;
    void renderNameKeyboard();
    ...
    bool appearanceValid_ = false;
    bool pendingCreate_ = false;
    int prevClassIndex_ = -1;
