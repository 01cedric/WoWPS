...
public:
    ...
    [[nodiscard]] float getCollisionHeight() const { return collisionHeight; }
    void setCollisionHeight(float height) {
        if (core::validCollisionHeight(height)) collisionHeight = height;
    }
...
protected:
    ...
    float collisionHeight = core::DEFAULT_COLLISION_HEIGHT;
