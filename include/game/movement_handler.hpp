...
public:
    ...
    [[nodiscard]] float getServerCollisionHeight() const { return serverCollisionHeight_; }
    void resetServerCollisionHeight() { serverCollisionHeight_ = core::DEFAULT_COLLISION_HEIGHT; }
    ...
    void handleCollisionHeightBroadcast(network::Packet& packet);
...
private:
    ...
    float serverCollisionHeight_ = core::DEFAULT_COLLISION_HEIGHT;
