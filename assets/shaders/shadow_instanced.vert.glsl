#version 450
// Same caster geometry, alpha coordinates and per-instance wind as shadow.vert.
// Dedicated frame-slot matrices cannot be overwritten by the later main pass.
...
void main() {
    ...
    if (foliageSway != 0) {
        vec3 worldRef = instanceModel[3].xyz;
