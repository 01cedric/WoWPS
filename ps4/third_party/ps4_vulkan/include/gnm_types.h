...
/* Note: GnmCommandBuffer, GnmRenderTarget, GnmDepthRenderTarget, GnmTexture,
 * GnmSampler, and GnmBuffer are defined as complete structs in their
 * respective headers (gnm_commandbuffer.h, gnm_rendertarget.h, etc.).
 * Do NOT forward-declare them here — it would conflict with the full
 * definitions.
 */
...
/* === Inline structs (used by multiple headers) === */
